...
module.exports = {
  ...
  P360_SOAP_URL: process.env.P360_URL || 'http://tfk-fh-siweb01t.login.top.no:8088/SI.WS.Core/SIF/',
  P360_SOAP_USER: process.env.P360_USER || 'domain/username',
  P360_SOAP_PASSWORD: process.env.P360_PASSWORD || 'password',
