...
module.exports = async ({ newDocument }) => {
  ...
  try {
    logger('info', ['generate-document-data', 'template', templateName, DOCUMENT_GENERATOR_URL, 'generate document'])
    ...
    logger('info', ['generate-document-data', 'template', templateName, DOCUMENT_GENERATOR_URL, 'document generated', data.data.base64.length])
