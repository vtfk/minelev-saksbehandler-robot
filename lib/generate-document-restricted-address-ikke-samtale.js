...
module.exports = async data => {
  ...
  const documentTemplate = getDocumentTemplate({ domain: 'minelev', templateId: 'hemmelig-adresse-ikke-samtale' })
  ...
  logger('info', ['generate-document-restricted-address-ikke-samtale', 'documentTemplate', data.documentTemplate, 'title', title])
