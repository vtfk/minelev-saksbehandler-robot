...
module.exports = data => {
  ...
  const template = templates('hemmelig-adresse-ikke-samtale', true).archive
  ...
  const documentData = {
    ...
    template: templates('hemmelig-adresse-ikke-samtale')
  }
  const fileData = generateDocumentData(documentData)
