const saveToNotifications = require('../steps/save-to-notifications')
...
module.exports = data => {
  return new Promise(async (resolve, reject) => {
    logger('info', ['flows', 'varsel', data._id, data.studentUserName])
    saveToNotifications(data)
    .then(prepareData)
